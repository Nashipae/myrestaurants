...
public class YelpService {
    ...
    public static void findRestaurants(String location, Callback callback) {
        ...
        HttpUrl.Builder urlBuider = HttpUrl.parse(Constants.YELP_BASE_URL).newBuilder();
        urlBuider.addQueryParameter(Constants.YELP_LOCATION_QUERY_PARAMETER, location);
